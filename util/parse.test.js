...

{
    ...
    // https://reservia.viarail.ca/tsi/GetTrainStatus.aspx?l=en&TsiCCode=VIA&TsiTrainNumber=15&ArrivalDate=2022-09-09
    const dirname = path.dirname(fileURLToPath(import.meta.url))
...
// {
//     /* Handles pages that show data from the previous day */
//     // https://reservia.viarail.ca/tsi/GetTrainStatus.aspx?l=en&TsiCCode=VIA&TsiTrainNumber=15&ArrivalDate=2022-09-10
//     const dirname = path.dirname(fileURLToPath(import.meta.url))
//     const html = readFileSync(path.resolve(dirname, './parse_stale.test.html'))

//     const actual = parseStatusPage(html).departureDate
//     const expected = 
